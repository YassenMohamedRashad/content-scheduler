...
Route::middleware('throttle:api')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::match(['put' , 'patch'],'/platforms/{id}/change-account-status' , [PlatformController::class, 'changePlatformAccountStatus']);


        Route::get('/analytics', [AnalyticsController::class, 'index']);
        Route::get('/analytics/activity-log', [AnalyticsController::class, 'getActivityLogHistory']);
    });
});
